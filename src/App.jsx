...
function App() {
  ...
  return (
    <div className='flex flex-col justify-center items-center font-LibreFranklin font-medium' >
      ...
      <p className='text-[0.7rem] mt-2 mb-6 font-light'>Subscribe and get notified</p>
      <form className='flex flex-col'>
        <input
         ...
         />
        <input
          className='bg-Colorblue text-white text-xs rounded-2xl h-9 font-semibold mb-[4rem]'
          value="Notify Me"
          type="submit"
        />
      </form>
      ...
      <p className='text-[0.6rem] text-colorGray'>© Copyright Ping. All rights reserved</p>
    </div>
  ) 
}
